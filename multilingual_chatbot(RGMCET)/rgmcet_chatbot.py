...
def create_gradio_interface():
    ...
    with gr.Blocks(css=css, theme=gr.themes.Soft()) as demo:
        ...
        language = gr.Dropdown(
            ...
            info="Choose your preferred language for responses / अपने उत्तर के लिए पसंदीदा भाषा चुनें / మీ సమాధానాల కోసం మీకు ఇష్టమైన భాషను ఎంచుకోండి // اپنے جوابات کے لیے ترجیحی زبان منتخب کریں / உங்கள் பதில்களுக்கு விருப்பமான மொழியைத் தேர்ந்தெடுக்கவும் / ನಿಮ್ಮ ಪ್ರತಿಕ್ರಿಯೆಗಳಿಗೆ ನಿಮ್ಮ ಆದ್ಯತೆಯ ಭಾಷೆಯನ್ನು ಆಯ್ಕೆ ಮಾಡಿ / तुमच्या प्रतिसादांसाठी तुमची पसंतीची भाषा निवडा"
        )
